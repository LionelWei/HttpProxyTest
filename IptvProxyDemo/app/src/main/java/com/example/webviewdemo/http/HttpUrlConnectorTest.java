            ...
            public void run() {
                ...
                try {
                    ...
                    if (true) {
                        ...
                        InetAddress address = InetAddress.getByAddress(new byte[] {(byte)192, (byte)168, (byte)251, 57});
//                                parseNumericAddress("192.168.251.57");

                        Proxy proxy = new Proxy(Proxy.Type.SOCKS, new InetSocketAddress(address, 9999));
